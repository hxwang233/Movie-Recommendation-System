 ...
 * geometry 映射信息
 */
export declare type IGeometry = Geometry & {
 ...
 * 子 plot 的配置
 */
export declare type IPlot = IPlotTypes & {
    /**
...
/** 配置类型定义 */
export interface MultiViewOptions extends Omit<Options, 'data' | 'legend' | 'xAxis' | 'yAxis' | 'legend' | 'tooltip' | 'slider' | 'scrollbar'> {
    /**
     * 是否同步子 view 的配置
