...
var Association = /** @class */ (function (_super) {
    ...
    Association.prototype.getAssociationItems = function (views, params) {
        ...
        if ((_a = event.data) === null || _a === void 0 ? void 0 : _a.data) {
            ...
            util_1.each(views, function (v) {
                ...
                var elements = util_1.map(utils_1.getAllElements(v), function (ele) {
                    var active = false;
                    var inactive = false;
                    if (utils_2.getElementValue(ele, field) === util_1.get(data_1, field)) {
                        active = true;
                    }
                    else {
                        inactive = true;
    ...
    Association.prototype.showTooltip = function (params) {
        var siblings = utils_1.getSilbingViews(this.context.view);
    ...
    Association.prototype.active = function (params) {
        var views = utils_1.getViews(this.context.view);
    ...
    Association.prototype.reset = function () {
        var views = utils_1.getViews(this.context.view);
        util_1.each(views, function (v) {
            utils_2.clearHighlight(v);
        });
    };
    return Association;
}(g2_1.Action));
g2_1.registerAction('association', Association);
/**
 * 相邻 view 的 active 联动（相同维值的 tooltip 联动）
 */
g2_1.registerInteraction('association-active', {
 ...
 * 相邻 view 的 active 联动（相同维值的 tooltip 联动）
 */
g2_1.registerInteraction('association-selected', {
 ...
 */
g2_1.registerInteraction('association-highlight', {
 ...
 */
g2_1.registerInteraction('association-tooltip', {
