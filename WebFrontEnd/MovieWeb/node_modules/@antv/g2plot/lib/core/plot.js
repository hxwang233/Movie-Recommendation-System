...
var Plot = /** @class */ (function (_super) {
    ...
    Plot.prototype.createG2 = function () {
        ...
        this.chart = new g2_1.Chart(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ container: this.container, autoFit: false }, this.getChartSize(width, height)), { localRefresh: false }), utils_1.pick(this.options, exports.PLOT_CONTAINER_OPTIONS)));
    ...
    Plot.prototype.bindSizeSensor = function () {
        ...
        if (autoFit) {
            this.unbind = size_sensor_1.bind(this.container, function () {
                // 获取最新的宽高信息
                var _a = utils_1.getContainerSize(_this.container), width = _a.width, height = _a.height;
