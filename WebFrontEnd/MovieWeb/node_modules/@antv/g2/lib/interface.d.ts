...
/** createTheme 主题样式表配置 */
export declare type StyleSheetCfg = Pick<StyleSheet, 'backgroundColor' | 'brandColor' | 'paletteQualitative10' | 'paletteQualitative20' | 'paletteSemanticRed' | 'paletteSemanticGreen' | 'paletteSemanticYellow' | 'fontFamily'>;
/** 交互反馈的定义 */
