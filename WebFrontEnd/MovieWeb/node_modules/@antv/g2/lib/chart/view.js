...
var View = /** @class */ (function (_super) {
    ...
    function View(props) {
        ...
        var _a = props.id, id = _a === void 0 ? util_1.uniqueId('view') : _a, parent = props.parent, canvas = props.canvas, backgroundGroup = props.backgroundGroup, middleGroup = props.middleGroup, foregroundGroup = props.foregroundGroup, _b = props.region, region = _b === void 0 ? { start: { x: 0, y: 0 }, end: { x: 1, y: 1 } } : _b, padding = props.padding, appendPadding = props.appendPadding, theme = props.theme, options = props.options, limitInPlot = props.limitInPlot, syncViewPadding = props.syncViewPadding;
        _this.parent = parent;
        _this.canvas = canvas;
    ...
    View.prototype.renderPaddingRecursive = function (isUpdate) {
        ...
        this.autoPadding = auto_1.calculatePadding(this).shrink(padding_1.parsePadding(this.appendPadding));
    ...
    View.prototype.renderLayoutRecursive = function (isUpdate) {
        ...
        var syncViewPaddingFn = this.syncViewPadding === true
            ...
            : util_1.isFunction(this.syncViewPadding)
    ...
    View.prototype.initOptions = function () {
        ...
        if (facets) {
            util_1.each(facets, function (facet) {
                var type = facet.type, rest = tslib_1.__rest(facet, ["type"]);
