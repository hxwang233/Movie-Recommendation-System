...
declare type ComponentLegendItem = Omit<LegendItem, 'marker'> & {
    marker: any;
};
/**
 * @ignore
 ...
 */
export declare function getLegendItems(view: View, geometry: Geometry, attr: Attribute, themeMarker: object, userMarker: any): ComponentLegendItem[];
/**
 *
 * @ignore
